...
public partial class GameEntity {
    ...
    public Code.Gameplay.Features.Movement.Rotation rotation { get { return (Code.Gameplay.Features.Movement.Rotation)GetComponent(GameComponentsLookup.Rotation); } }
    ...
    public GameEntity AddRotation(float newValue) {
        ...
        var component = (Code.Gameplay.Features.Movement.Rotation)CreateComponent(index, typeof(Code.Gameplay.Features.Movement.Rotation));
