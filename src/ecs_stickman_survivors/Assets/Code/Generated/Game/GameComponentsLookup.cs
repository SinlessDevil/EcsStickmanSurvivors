...
public static class GameComponentsLookup {
    ...
    public const int BombBoltAbility = 14;
    ...
    public const int ArmamentBombVisual = 26;
    public const int Bomb = 27;
    public const int BounceRate = 28;
    public const int EffectSetups = 29;
    public const int Processed = 30;
    public const int Separable = 31;
    public const int StatusSetups = 32;
    public const int Target = 33;
    public const int TargetLimit = 34;
    public const int Booster = 35;
    public const int BoosterSpawnTimer = 36;
    ...
    public const int SpeedEffect = 48;
    public const int TargetId = 49;
    public const int EnchantHolder = 50;
    public const int EnchantTypeId = 51;
    public const int EnchantVisuals = 52;
    public const int ExplosiveEnchant = 53;
    public const int HexEnchant = 54;
    public const int PoisonEnchant = 55;
    public const int BuffTimer = 56;
    public const int CreateEffectInterval = 57;
    public const int Enemy = 58;
    public const int EnemyAnimator = 59;
    public const int EnemyShaman = 60;
    public const int EnemyTypeID = 61;
    public const int RadiusToFindEnemy = 62;
    public const int ReloadingTimer = 63;
    public const int SpawnTimer = 64;
    public const int Hero = 65;
    public const int HeroAnimator = 66;
    public const int ExperienceMeter = 67;
    public const int LevelUp = 68;
    public const int CurrentHp = 69;
    public const int Dead = 70;
    public const int MaxHp = 71;
    public const int ProcessingDeath = 72;
    public const int Collected = 73;
    public const int Experience = 74;
    public const int LootTypeId = 75;
    public const int PickupRadius = 76;
    public const int Pullable = 77;
